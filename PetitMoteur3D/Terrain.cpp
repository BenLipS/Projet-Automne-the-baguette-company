...
namespace PM3D {
	...
	*/
	...
	{
		x = ((x) / (scale.x) + (width / 2.0f));  // on remet les coordonn�es dans le r�f�renciel de la heightmap
		z = ((z) / (scale.z) + (height / 2.0f));	// on remet les coordonn�es dans le r�f�renciel de la heightmap
